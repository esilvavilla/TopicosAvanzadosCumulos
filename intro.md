# Formación y Evolución de Cúmulos Estelares

## Horario del curso y aula de clase
- El horario del curso será los lunes de 8 a 10 de la mañana
- El aula para el curso será la 6-426
...
| Aula | 6-426
| Horario | L 8-10AM
| Evaluación 1a mitad | 30% seguimiento / 70% examen

A continuación se presenta la hoja de ruta temática estructurada para los dos meses del curso de maestría:

### Semana 1: El Medio Interestelar y las Condiciones Iniciales.
* Observaciones del gas frío y jerarquía espacial (nubes, grumos, núcleos).
* Física del equilibrio: Esferas hidrostáticas y de Bonnor-Ebert.
* Inestabilidad gravitacional: Teorema del Virial y derivación de la Masa/Longitud de Jeans.

### Semana 2: Del Núcleo a la Estrella.
* Dinámica del colapso de una nube a una estrella (modelo de colapso de adentro hacia afuera de Shu).
* Clasificación de Objetos Estelares Jóvenes (YSOs: Clases 0 a III).
* Evolución en la pre-secuencia principal (trazas de Hayashi y Henyey).

### Semana 3: Poblaciones Estelares y la IMF.
* Transición de núcleos fragmentados a cúmulos embebidos.
